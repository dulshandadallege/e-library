...
import { NewspaperAddPopupComponent } from './newspaper-add-popup/newspaper-add-popup.component';
import { GrovenmentAddPopupComponent } from './grovenment-add-popup/grovenment-add-popup.component';
...
@NgModule({
  declarations: [
    ...
    NewspaperAddPopupComponent,
    GrovenmentAddPopupComponent,
    OlaLeafComponent
  ],
  imports: [
    BrowserModule,
  ...
  entryComponents: [BookAddPopupComponent],
  providers: [],
